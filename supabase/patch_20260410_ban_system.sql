...
-- 2026-04-10
-- Full idempotent schema patch for production ban system, guest presence, RLS hardening,
-- admin moderation RPCs, realtime ban propagation, and storage protection.
